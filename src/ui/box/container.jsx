...
const IPHONE =
  global.navigator && !!global.navigator.userAgent.match(/iPhone/i);
...
export default class Container extends React.Component {
  ...
  checkConnectionResolver(done) {
    ...
    const userInputValue =
      c.getFieldValue(lock, "username") || c.getFieldValue(lock, "email");
    connectionResolver(userInputValue, context, (resolvedConnection) => {
      swap(updateEntity, "lock", l.id(lock), (m) =>
        l.setResolvedConnection(m, resolvedConnection),
      );
      done();
    });
  }
